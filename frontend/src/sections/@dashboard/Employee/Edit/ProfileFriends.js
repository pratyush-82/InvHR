...
export default function ProfileFriends({ isEdit = false, currentemployee, setCurrentTab }) {
  ...
  const defaultValues = useMemo(
    () => ({
      ...
      technologies:
        currentemployee.technologies && currentemployee.technologies.length > 0
          ? currentemployee.technologies
          : [],
      organizations:
        currentemployee.organizations && currentemployee.organizations.length > 0
