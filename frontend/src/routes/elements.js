...
export const PolicyAgreementPage = Loadable(lazy(()=>import('../pages/auth/PolicyAgreementPage')))
...
export const GeneralPolicyListPage = Loadable(
  lazy(() => import('../pages/dashboard/GeneralPolicyListPage'))
);
...
// DASHBOARD: Policy
export const PolicyListPage = Loadable(lazy(() => import('../pages/dashboard/PolicyListPage')));
export const PolicyNewAdd = Loadable(
  lazy(() => import('../sections/@dashboard/policy/AddNewPolicyForm'))
);
export const PoliciesListPage = Loadable(lazy(() => import('../pages/dashboard/PoliciesListPage')));

// DASHBOARD: EmployeeAppraisal
export const EmployeeAppraisalListPage = Loadable(
  lazy(() => import('../pages/dashboard/EmployeeAppraisalListPage'))
);
...
// DASHBOARD: HOLIDAY
export const HolidayListPage = Loadable(lazy(() => import('../pages/dashboard/HolidayListPage')));
export const HolidayBranchList = Loadable(
  lazy(() => import('../pages/dashboard/HolidayBranchListPage'))
);

// DASHBOARD: LEAVE SETTING
export const LeaveSettingPage = Loadable(lazy(() => import('../pages/dashboard/LeaveSettingPage')));
// DASHBOARD LEAVE
export const LeavePage = Loadable(lazy(() => import('../pages/dashboard/LeavePage')));

// DASHBOARD: Project
export const ProjectListPage = Loadable(lazy(() => import('../pages/dashboard/ProjectListPage')));
export const ProjectNewAdd = Loadable(
  lazy(() => import('../sections/@dashboard/project/AddNewProjectForm'))
);

// DASHBOARD DESIGNATION
export const DesignationListPage = Loadable(
  lazy(() => import('../pages/dashboard/DesignationListPage'))
);
export const DesignationCreatePage = Loadable(
  lazy(() => import('../pages/dashboard/DesignationCreatePage'))
);
export const DesignationEditPage = Loadable(
  lazy(() => import('../pages/dashboard/DesignationEditPage'))
);
export const DesignationViewPage = Loadable(
  lazy(() => import('../pages/dashboard/DesignationViewPage'))
);

// DASHBOARD: LEAVE MANAGEMENT
export const LeaveManagementListPage = Loadable(
  lazy(() => import('../pages/dashboard/LeaveApprovalBucketListPage'))
);

// DASHBOARD: TIMESHEET MANAGEMENT
export const TimeSheetManagementPage=Loadable(lazy(()=>import('../pages/dashboard/TimeSheetManagementPage')))
